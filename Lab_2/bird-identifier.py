...
imgatt = pd.read_csv("dataset/CUB_200_2011/attributes/image_attribute_labels.txt",
...
imglabels = pd.read_csv("dataset/CUB_200_2011/image_class_labels.txt", 
...
birds = pd.read_csv("dataset/CUB_200_2011/classes.txt",
...
max_features_opts = range(5, 60, 5)
